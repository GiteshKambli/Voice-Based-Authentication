...
function SignInUp() {
  ...
  const updateUsrName = (e) => {
    dispatch(changed(e.target.value.toLowerCase()))
        ...
        <div className='signin-signup'>
          <form action='' className='sign-in-form'>
            ...
            <div className='input-field'>
              ...
              <input type="text" placeholder='Username' name="usrname" /*onChange={(e) => dispatch(changed(e.target.value.toLowerCase()))}*/ onChange={(e) => updateUsrName(e)}  value={usrname}/>
              {/* <FontAwesomeIcon icon={faSpinner} className='font-awesome-spin' /> */}
            </div>
            {username}
            <Link to='/audio/'>
            {/* <a href='file:///D:/Sem-VI/DBM%20Hackathon/client/src/pages/audioInput.html'> */}
