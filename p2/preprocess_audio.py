...
def get_mel(path):
    audio, mel = pattern_generate(path, params['N_FFT'], params['Mel_Dim'], params['Sample_Rate'],
                                  params['Frame_Shift'],
...
if __name__ == '__main__':
    #mel = open(r'wav files/mel1.wav')
    mel = get_mel('p2/wav files/mel1.wav')
    print(mel.shape)
    #np.save('mel1.npy', mel)